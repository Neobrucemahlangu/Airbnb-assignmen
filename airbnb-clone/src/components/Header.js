  ...
  return (
    <header className="header">
        ...
        <input
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              ...
              if (city) navigate(`/location/${city}`);
            }
          }}
        />
      </div>
      ...
      <div className="header-right">
        {user ? (
          <span className="host-link">Welcome, {user.username}</span>
        ) : (
        ...
        <div className="profile-dropdown">
          ...
          <div className="dropdown-content">
            {user ? (
              <>
                <span onClick={() => navigate("/reservations")}>Reservations</span>
